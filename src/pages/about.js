...
import path1 from '../images/about/path1.png';
import sensor from '../images/about/sensor.png';
import companies from '../images/about/companies.png';
import perc from '../images/about/perception.png';
import opac from '../images/about/opacity.png';
...
export default function About() {
  ...
  const paragraph = [
    ...
    {
      title: '',
      content: 'The analysis lead to the definition of an essential path of data, represented below, that was then used as the backbone to draw the path shown in this website. ',
      diag: path1,
      ordine: 'terzouno',
    },
    {
